...
*/
	...
	$administrar_link = HTTP . '/administrar"';
	...
	$administrar = '<a class="has-text-white" href="'. $administrar_link .'">Administrar</a>';
    ...
    if(isset($activo)){
        ...
        switch($activo){
			...
			case 'administrar':
				$administrar = '<a class="has-text-dark" href="'. $administrar_link  .'"><strong>Administrar</strong></a>';
				break;
		}
    }
	...
	{ $is_admin = '<p class="level-item">' . $administrar.'</p>'; }
